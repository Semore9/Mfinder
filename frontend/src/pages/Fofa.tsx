...
import {copy, copyCol, copyColByID, copyRow, getAllDisplayedColumnKeysNoIndex} from "@/util/util";
...
import {ColDef, GetContextMenuItemsParams, SideBarDef} from "ag-grid-community";
...
const TabContent: React.FC<TabContentProps> = (props) => {
    ...
    const [columnDefs] = useState<ColDef[]>(props.colDefs || [
        ...
        {headerName: 'URL', field: "link", width: 300, pinned: 'left', tooltipField: 'link'}, //资产的URL链接, 权限：无
        {headerName: '域名', field: "domain", width: 150, hide: true, tooltipField: 'domain'}, //域名, 权限：无
        {headerName: 'IP', field: "ip", width: 150, tooltipField: 'ip'}, //ip地址, 权限：无
        {headerName: '端口', field: "port", width: 80, tooltipField: 'port'}, //端口, 权限：无
        {headerName: '协议名', field: "protocol", width: 80, tooltipField: 'protocol'}, //协议名, 权限：无
        {headerName: '基础协议', field: "base_protocol", width: 100, hide: true, tooltipField: 'base_protocol'}, //基础协议，比如tcp, 权限：无
        {headerName: '网站标题', field: "title", width: 200, tooltipField: 'title'}, //网站标题, 权限：无
        {headerName: 'icp备案号', field: "icp", width: 200, tooltipField: 'icp'}, //icp备案号, 权限：无
        {headerName: '主机名', field: "host", width: 200, tooltipField: 'host', hide: true}, //主机名, 权限：无
        {headerName: '证书', field: "cert", width: 100, hide: true, tooltipField: 'cert'}, //证书, 权限：无
        {headerName: '操作系统', field: "os", width: 100, hide: true, tooltipField: 'os'}, //操作系统, 权限：无
        {headerName: '网站server', field: "server", width: 100, hide: true, tooltipField: 'server'}, //网站server, 权限：无
        {headerName: '网站header', field: "header", width: 100, hide: true, tooltipField: 'header'}, //网站header, 权限：无
        {headerName: '协议banner', field: "banner", width: 100, hide: true, tooltipField: 'banner'}, //协议banner, 权限：无
        {
            headerName: '产品名',
            field: "product",
            width: 100,
            hide: true,
            toolPanelClass: 'professional-privilege',
        ...
        {
            headerName: 'icon_hash',
            field: "icon_hash",
            width: 100,
            hide: true,
            toolPanelClass: 'commercial-privilege',
            tooltipField: 'icon_hash'
        ...
        }, //网站正文内容, 权限：商业版本及以上
        {
            ...
            width: 100,
            hide: true,
            toolPanelClass: 'enterprise-privilege',
            tooltipField: 'icon'
        }, //icon图标, 权限：企业会员
        {
            headerName: 'fid',
        ...
        }, //fid, 权限：企业会员
        {
            ...
            hide: true,
            toolPanelClass: 'enterprise-privilege',
            tooltipField: 'structinfo'
        }, //结构化信息(部分协议支持、比如elastic、mongodb), 权限：企业会员
        {headerName: '国家代码', field: "country", width: 100, hide: true, tooltipField: 'country'}, //国家代码, 权限：无
        {headerName: '国家名', field: "country_name", width: 100, hide: true, tooltipField: 'country_name'}, //国家名, 权限：无
        {headerName: '区域', field: "region", width: 100, hide: true, tooltipField: 'region'}, //区域, 权限：无
        {headerName: '城市', field: "city", width: 100, hide: true, tooltipField: 'city'}, //城市, 权限：无
        {headerName: '经度', field: "longitude", width: 100, hide: true, tooltipField: 'longitude'}, //地理位置经度, 权限：无
        {headerName: '纬度', field: "latitude", width: 100, hide: true, tooltipField: 'latitude'}, //地理位置纬度, 权限：无
        {headerName: 'asn编号', field: "as_number", width: 100, hide: true, tooltipField: 'as_number'}, //asn编号, 权限：无
        {headerName: 'asn组织', field: "as_organization", width: 100, hide: true, tooltipField: 'as_organization'}, //asn组织, 权限：无
        {headerName: 'jarm指纹', field: "jarm", width: 100, hide: true, tooltipField: 'jarm'}, //jarm指纹, 权限：无
    ]);
    ...
    return <Flex vertical gap={5} style={{height: '100%'}}>
        ...
        <div style={{display: searchType === "统计聚合" ? 'block' : 'none', width: "100%", height: "100%"}}>
            <FofaStatisticalAggregation ref={statisticalAggsRef}/></div>
        <div style={{display: searchType === "Host聚合" ? 'block' : 'none', width: "100%", height: "100%"}}>
            <FofaHostAggs ref={hostAggsRef}/></div>
