import { Button, Flex, Input, Space, Tooltip, message } from "antd";
...
const FileSelector: React.FC<DirectorySelectorProps> = (props) => {
  ...
  return (
    <Flex justify={"left"}>
      ...
      <Space.Compact size={"small"} style={{ width: "100%" }}>
        ...
        <Button icon={<FileSearchOutlined />} onClick={openFileDialog}>
          选择
        </Button>
      </Space.Compact>
    </Flex>
