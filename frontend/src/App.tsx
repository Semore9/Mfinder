...
import SecurityProcess from "@/pages/SecurityProcess";
...
LicenseManager.setLicenseKey(
  "[v3][Release][0102]_NDEwMjI5OTk5MzAwMA==ab24fd9f2af3b5617494923ea58bebea",
);
ModuleRegistry.registerModules([AllEnterpriseModule]);
provideGlobalGridOptions({
  theme: themeQuartz.withParams({ rowBorder: true, columnBorder: true }),
...
const App: React.FC = () => {
  ...
  const [tabs, setTabs] = useState<Tab[]>([
    ...
    },
    {
      key: "杀软识别",
      label: "杀软识别",
      children: <SecurityProcess />,
    },
    {
      key: "提权辅助",
      label: "提权辅助",
      children: <PrivilegeEscalation />,
    },
    {
      key: "小程序反编译",
      label: "小程序反编译",
    ...
    (async () => {
      Environment().then((r) => {
        if (r.buildType === "dev") {
          setTabs((prevState) => [
            ...prevState,
            { key: "TEST", label: "TEST", children: <Test /> },
          ]);
        }
      });
      try {
        ...
        <AntdApp style={{ height: "100%" }}>
          <div className={styles.appContainer}>
            ...
            >
              <Modal
                ...
                modalRender={(modal) => (
                  ...
                  >
                    <div className={styles.modalContainer} ref={draggleRef}>
                      {modal}
                    </div>
                  </Draggable>
                )}
            ...
            {loading ? (
              ...
              <>
                <Lay.Header style={CssConfig.title}>
                  <Bar />
                </Lay.Header>
                <Tabs
